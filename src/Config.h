...
inline constexpr char kAnimationBlockPrefix[] = "animation:";
inline constexpr char kAssetEndMarker[] = "%%";
inline constexpr char kAssetBlockMarker = '%';
inline constexpr char kAssetCommentMarker = ';';
inline constexpr int kMinimumAssetHeaderLength = 3;
inline constexpr int kHeaderContentOffset = 1;
inline constexpr int kHeaderMarkerCount = 2;
